                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">ตั้งค่าหมวดหมู่อุปกรณ์</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="card-header">
                                    <h3 class="card-title"> <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalLong">
                                            ...
                                            เพิ่มหมวดหมู่อุปกรณ์</button></h3>
                                </div>
                                        ...
                                        <table id="example" class="display nowrap">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="text-align: center;">หมวดหมู่อุปกรณ์</th>
                                            ...
                                            <tbody>
                                                <?php
                                                $i = 1;
                                                $sql_se = "SELECT * FROM category_it";
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <div style="display: none;">
                                                            <input name="id_k<?= $i ?>" type="text" value="<?= $rs_cate['cate_id'] ?>">
                                                ...
                                                for ($i = 1; $i <= $total; $i++) {
                                                    if (isset($_POST["del$i"])) {
                                                        $id_k = $_POST["id_k$i"];
                                                        $sql_del = "DELETE FROM category_it WHERE cate_id ='$id_k'";
                                                        $qr_del = mysqli_query($conn, $sql_del);
                                                        if ($qr_del) {
                                                            echo "<script>swal({
                                                        title: 'ลบหมวดสำเร็จ!', //ข้อความ เปลี่ยนได้ เช่น บันทึกข้อมูลสำเร็จ!!
                                                   //  text: 'Redirecting in 3 seconds.', //ข้อความเปลี่ยนได้ตามการใช้งาน
                                                        ...
                                                        window.location.href ='index.php?page=category_it'; //หน้าเพจที่เราต้องการให้ redirect ไป อาจใส่เป็นชื่อไฟล์ภายในโปรเจคเราก็ได้ครับ เช่น admin.php
                                                        })</script>";
    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">เพิ่มหมวดหมู่อุปกรณ์</h5>
                ...
                <div class="col-md-12">
                    <form method="POST">
                        <div class="form-group">
                            <label for="exampleInputEmail1">ชื่อหมวดอุปกรณ์</label>
                    ...
                    if (isset($_POST['btn_send'])) {
                        ...
                        $sql_cate = "INSERT INTO category_it (cate_name) VALUES ('$name')";
                        $qr_cate = mysqli_query($conn, $sql_cate);
                        if ($qr_cate) {
                            echo "<script>swal({
                                title: 'เพิ่มหมวดสำเร็จ!', //ข้อความ เปลี่ยนได้ เช่น บันทึกข้อมูลสำเร็จ!!
                           //  text: 'Redirecting in 3 seconds.', //ข้อความเปลี่ยนได้ตามการใช้งาน
                                type: 'success', //success, warning, danger
                                timer: 2000, //ระยะเวลา redirect 3000 = 3 วิ เพิ่มลดได้
                                showConfirmButton: false //ปิดการแสดงปุ่มคอนเฟิร์ม ถ้าแก้เป็น true จะแสดงปุ่ม ok ให้คลิกเหมือนเดิม
