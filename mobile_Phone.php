...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    window.open('','_self').close()
                                ...
                                <center>
                                    ...
                                    <br>
                                    <div>
                                        <Textarea name="txtar" class="textarea-conrol"
                            ...
                            if (isset($_POST['next'])) {
                                ...
                                if ($name == '' || $dept = '') {
                                    ...
                                    //  text: 'กรุณารอสักครู่ ไอทีได้รับข้อความที่คุณส่งแล้ว', //ข้อความเปลี่ยนได้ตามการใช้งาน
                                        ...
                                        window.location.href ='mobile_phone.php'; //หน้าเพจที่เราต้องการให้ redirect ไป อาจใส่เป็นชื่อไฟล์ภายในโปรเจคเราก็ได้ครับ เช่น admin.php
                                        })</script>";
                                } else {
...
$path_link = '1';
                                    ...
                                    $sql_line = "INSERT INTO it_problem (itp_date,itp_dept,itp_dept_id,itp_name,itp_detail,itp_ip,itp_anydesk,itp_status,itp_problem,itp_user,itp_picture) VALUES ('$date','$dept_dept','$dept_id','$name','$txtar','$ip','','1','','','$path_link')";
                                    ...
                                    //  text: 'กรุณารอสักครู่ ไอทีได้รับข้อความที่คุณส่งแล้ว', //ข้อความเปลี่ยนได้ตามการใช้งาน
                                        ...
                                        window.location.href ='get_connect_it.php?line_mobile=yes'; //หน้าเพจที่เราต้องการให้ redirect ไป อาจใส่เป็นชื่อไฟล์ภายในโปรเจคเราก็ได้ครับ เช่น admin.php
                                        })</script>";
